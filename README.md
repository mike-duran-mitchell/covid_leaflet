Data experiments displayed [LeafletJS](https://leafletjs.com/) with data scraped from https://projects.oregonlive.com/coronavirus/cases-by-zip. Files are still cluttered because I'm working with leaflet and [Turf](http://turfjs.org/) while having some data that is relevant for me and comparable as the entire world is doing inference off of similar data.


Uses  [CoreUI React Admin Template](https://coreui.io/react/)
